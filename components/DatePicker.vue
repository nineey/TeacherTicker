...
<template>
  <VueDatePicker id="customCSS" v-model="useStore.selectedDate" inline auto-apply :enable-time-picker="false" />
</template>
...
.dp__main :deep(.dp__theme_light) {
  ...
  --dp-danger-color: #519E34;
  --dp-highlight-color: #519E34;
  border-radius: 1em;
